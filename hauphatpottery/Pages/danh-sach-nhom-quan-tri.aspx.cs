...
namespace hauphatpottery.Pages
{
    public partial class danh_sach_nhom_quan_tri : System.Web.UI.Page
    {
        ...
        {
            bool isPermission = _UnitDataRepo.checkPermissionPage("danh-sach-nhom-quan-tri.aspx", Utils.CIntDef(Session["groupId"]), Utils.CIntDef(Session["groupType"]));
            if (!isPermission)
            {
        ...
        {
            return Utils.CIntDef(grouptype) == 1 ? "Admin" : "Editor";
        }
        #endregion
        #region Buttion
