<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="chi-tiet-khach-hang.aspx.cs" Inherits="hauphatpottery.Pages.chi_tiet_khach_hang" %>
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="3">
                                        ...
                                        <tr>
                                            <td class="td_left" align="right" valign="top" nowrap="nowrap">
                                                <span style="color: Red;">*</span>&nbsp;Họ tên/Công ty
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Chưa nhập họ tên/công ty"
