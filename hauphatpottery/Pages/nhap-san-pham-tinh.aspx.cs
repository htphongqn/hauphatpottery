...
{
    public partial class nhap_san_pham_tinh : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            bool isPermission = _UnitDataRepo.checkPermissionPage("nhap-san-pham-tinh.aspx", Utils.CIntDef(Session["groupId"]), Utils.CIntDef(Session["groupType"]));
            if (!isPermission)
            {
        ...
        public int getSoluongConlai(object quantity, object orderId, object productDetailId)
        {
            ...
            int _orderid = Utils.CIntDef(orderId);
            int _prodetailid = Utils.CIntDef(productDetailId);
            var sumDalam = getSoluongTinhDalam(_orderid, _prodetailid);
        ...
        protected void lbtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                item.PRODUCT_DETAIL_ID = Utils.CIntDef(ddlProductDetail.SelectedValue);
