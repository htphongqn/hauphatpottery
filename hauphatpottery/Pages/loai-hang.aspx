<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="loai-hang.aspx.cs" Inherits="hauphatpottery.Pages.loai_hang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    ...
    <table width="100%" cellpadding="3" cellspacing="3" style="background-color: #f4f4f4;
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_Type" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Loại hàng" FieldName="Name"  Width="250px">
                            <DataItemTemplate>
