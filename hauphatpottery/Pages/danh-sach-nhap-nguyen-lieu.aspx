<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-nhap-nguyen-lieu.aspx.cs" Inherits="hauphatpottery.Pages.danh_sach_nhap_nguyen_lieu" %>
...
<div id="header">
        ...
        <div class="toolbar" style="margin-left: 1006px; margin-top: -38px;">
            &nbsp;<a href="nhap-nguyen-lieu.aspx" title="Nhập nguyên liệu" class="k-button"><span
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlCompany" CssClass="k-textbox textbox" AppendDataBoundItems="true" DataTextField="Name" DataValueField="Id">
            ...
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_OrderMaterial" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Mã Nhập" FieldName="CODE"  Width="120px">
                            <DataItemTemplate>
                                <a href="<%# getlink(Eval("ID")) %>" title='<%# Eval("CODE")%>'>
                                    <%# getShortString(Eval("CODE"), 40)%></a>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Công ty" Width="250px">
                            <DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Người nhập">
                            <DataItemTemplate>
