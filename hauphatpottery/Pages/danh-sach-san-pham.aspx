<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-san-pham.aspx.cs" Inherits="hauphatpottery.Pages.danh_sach_san_pham" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    <div id="header">
        ...
        <div class="toolbar" style="margin-left: 1006px; margin-top: -38px;">
            &nbsp;<a href="chi-tiet-san-pham.aspx" title="Thêm sản phẩm" class="k-button"><span
    ...
    <table width="100%" cellpadding="3" cellspacing="3" style="background-color: #f4f4f4;
        ...
        <tr>
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_Product" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Mã Sản Phẩm" FieldName="CODE"  Width="250px">
                            <DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Sản phẩm chi tiết" FieldName="CODE"  Width="250px">
                            <DataItemTemplate>
                                <a href="<%# getlinkdetail(Eval("ID")) %>">Xem</a>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
