    ...
    <asp:Panel ID="pnContract" runat="server">
        <table>
            <tbody>
                ...
                OnClick="lbtnSave_Click" ValidationGroup="G2">Xuất</asp:LinkButton>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_Order_ProductDetail" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Số lượng thô đã làm" Width="180px">
                            <DataItemTemplate>
                                <%# getFormatQuantity(getSoluongDalam(Eval("ORDER_ID"), Eval("PRODUCT_DETAIL_ID")))%>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>    
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Số lượng tinh đã làm" Width="180px">
                            <DataItemTemplate>
