...
{
    public partial class nhap_san_pham_tinh_nham : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            bool isPermission = _UnitDataRepo.checkPermissionPage("nhap-san-pham-tinh-nham.aspx", Utils.CIntDef(Session["groupId"]), Utils.CIntDef(Session["groupType"]));
            if (!isPermission)
            {
