<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-khach-hang.aspx.cs" Inherits="hauphatpottery.Pages.danh_sach_khach_hang" %>
            ...
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_Customer" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Họ tên/Công ty" FieldName="FULLNAME"  Width="250px">
                            <DataItemTemplate>
                                <a href="<%# getlink(Eval("ID")) %>" title='<%# Eval("FULLNAME")%>'>
                                    <%# getShortString(Eval("FULLNAME"), 40)%></a>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn> 
