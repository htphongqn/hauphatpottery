...
namespace hauphatpottery.Components
{
    ...
    {
        public string FormatMoneyNotext(object Expression)
        {
            try
            {
        ...
        public string PageList_1(int Quantity, int PageSize, int ActivePage, string Url, string ActiveClass)
        {
            int _dAllList = Quantity;
            int _iActivePage = ActivePage;
            int _iPageSize = PageSize;

            int _iPage = (_dAllList % _iPageSize) > 0 ? (_dAllList / _iPageSize) + 1 : _dAllList / _iPageSize;
            ...
            if (_iPage > 1)
            {
                if (_iPage <= 10)
                {
                    for (int i = 1; i <= _iPage; i++)
                    {
                        if (i == _iActivePage)
                        {

                            _sResult += "<a class='" + ActiveClass + "'>" + i + "</a>&nbsp;";
                        }
                        else
                        {
                            _sResult += "<a href='/" + Url + "" + i + "'>" + i + "</a>&nbsp;";
                        }
                    }
                    if (_iActivePage == 1)
                    {
                        _sResult = _sResult + "<a href='/" + Url + "" + 2 + "'>></a>&nbsp;";
                    }
                    else if (_iActivePage == _iPage)
                    {
                        _sResult = "<a href='/" + Url + "" + (_iActivePage - 1) + "'><</a>&nbsp;" + _sResult;
                    }
                    else
                    {
                        _sResult = "<a href='/" + Url + "" + (_iActivePage - 1) + "'><</a>&nbsp;" + _sResult + "<a href='/" + Url + "" + (_iActivePage + 1) + "'>></a>&nbsp;";
                    }
                }
                else
                {
                    if (_iActivePage <= 5)
                    {
                        ...
                        if (_iActivePage == 1)
                        {
                            _sResult = _sResult + "<a href='/" + Url + "" + (_iActivePage + 1) + "'>></a>&nbsp" + "<a href='/" + Url + "" + _iPage + "'>>|</a>&nbsp";
                        }
                        else
                        {
                            _sResult = "<a href='/" + Url + "" + (_iActivePage - 1) + "'><</a>&nbsp" + _sResult + "<a href='/" + Url + "" + (_iActivePage + 1) + "'>></a>&nbsp" + "<a href='/" + Url + "" + _iPage + "'>>|</a>&nbsp";
                        }
                    }
                    else if (_iActivePage >= _iPage - 5)
                    {
                        for (int i = Utils.CIntDef(_iPage) - 10; i <= Utils.CIntDef(_iPage); i++)
                        {
                            if (i == _iActivePage)
                            {
                            ...
                            {
                                _sResult += "<a href='/" + Url + "-page-" + i + "'>" + i + "</a>&nbsp;";
                            }
                        }
                        if (_iActivePage <= _iPage - 5)
                        {
                            _sResult = "<a href='/" + Url + "" + 1 + "'>|<</a>&nbsp<a href='/" + Url + "" + (_iActivePage - 1) + "'><</a>&nbsp" + _sResult;
                        }
                        else
                        {
                            _sResult = "<a href='/" + Url + "-page-" + 1 + "'>|<</a>&nbsp<a href='/" + Url + "-page-" + (_iActivePage - 1) + "'><</a>&nbsp" + _sResult + "<a href='/" + Url + "-page-" + (_iActivePage + 1) + "'>></a>&nbsp" + "<a href='/" + Url + "-page-" + _iPage + "'>>|</a>&nbsp";
                        }
                    }
                    else if (_iActivePage > 5)
                    {
                        for (int i = _iActivePage - 5; i <= _iActivePage + 5; i++)
                        {
                            if (i == _iActivePage)
                            {
                        ...
                        _sResult = "<a href='/" + Url + "" + 1 + "'>|<</a>&nbsp<a href='/" + Url + "" + (_iActivePage - 1) + "'><</a>&nbsp" + _sResult + "<a href='/" + Url + "" + (_iActivePage + 1) + "'>></a>&nbsp<a href='/" + Url + "" + _iPage + "'>>|</a>&nbsp";
                    }
                }
            }
            return _sResult;
